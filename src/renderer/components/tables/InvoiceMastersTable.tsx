      ...
      <table className="min-w-full border-collapse text-sm">
        <thead className="bg-gray-100 border-b border-gray-300">
          <tr>
            ...
            <th className="p-2 border border-gray-300 text-right">Taxable Value</th>
            <th className="p-2 border border-gray-300 text-right">Bill Amount</th>
          ...
          {invoiceMasters.map((inv, index) => {
            ...
            return (
              <tr key={inv.id} className="border-b hover:bg-gray-50">
                ...
                <td className="p-2 border border-gray-300 text-right">{inv.taxableValue}</td>
